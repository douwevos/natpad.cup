 ...
 *
 * @see     net.natpad.cup.model.parser.generated.runtime.LrParser
 * @version last updated: 7/3/96
 * @author  Frank Flannery
 */

public class LrVirtualParseStack {

	/** Constructor to build a virtual stack out of a real stack. */
	public LrVirtualParseStack(Stack shadowing_stack) throws java.lang.Exception {
		/* sanity check */
	...
	protected void get_from_real() {
		...
		stack_sym = (LrSymbol)real_stack.elementAt(real_stack.size()-1-real_next);
